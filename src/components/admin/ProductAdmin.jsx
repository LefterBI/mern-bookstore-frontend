...
const ProductAdmin = () => {
  ...
  // Verificare autentificare la încărcare
  useEffect(() => {
  ...
  // Gestionare căutare (cu debounce)
  ...
  // Salvare sau Actualizare Produs
  ...
  // Schimbare status (Activ/Inactiv)
  const handleToggleStatus = async (productId, currentStatus) => {
    try {
      ...
      const response = await fetch(`${API_URL}/api/admin/products/${productId}`, {
        ...
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`, // FIX: Adăugat backticks
        },
        ...
        <div className="admin-modal-overlay">
          <div className="admin-modal-content">
            ...
            <form onSubmit={handleSaveProduct} className="admin-product-form">
             ...
             <div className="admin-form-row">
              <input type="text" placeholder="nr. de pagini" value={formData.pages}
